...
const columnData = [
    ...
    [
        {
            ...
            result: [
                ...
                ['-Segment', '85', '45-70%'],
                ['-lym.', '11', '20-45%'],
                ['Hb', '12.1', '13.5-17.5 g/dL'],
                ['Platelet', '253', '150-400'],
            ]
        },
        { text: 'Glucose', result: [['Glucose', '102', '70-199']] },
        { text: 'Na/K', result: [
                ['Na', '141', '136-145'],
                ['K', '4.5', '3.5-5.0']
            ] },
        ...
        { text: 'CRP', result: [['CRP', '25', '<5']] },
        { text: 'Hs-Troponin I', result: [['Hs-Troponin I', '10', '<26']] },
        { text: 'Albumin', result: [['Albumin', '4.2', '3.8-5.3']] },
        { text: '', result: [['', '', '']] },
        { text: '', result: [['', '', '']] }
    ],
    // 欄位 2: 其他檢查
    [
        ...
        { 
            text: 'VBG', 
            result: [
                ['ABG-pH', '7.42', '7.35-7.45'],
                ['ABG-PCO2', '27.2.0', '35-45'],                
                ['ABG-PO2', '35.1', '80-100'],
                ['ABG-HCO3', '19.5', '21-28'],
                ['ABG-Base Excess', '-2.6', ''],
            ]
        },
        { text: 'D-Dimer', result: [['D-Dimer', '26', '<500 ng/mL']] },
        { text: 'PT/aPTT', result: [['PT/aPTT', '12 / 30', '11-14 / 25-35 sec']] },
        { text: 'Lactate', result: [['Lactate', '3.5', '0.4-2.0']] },
        { text: '', result: [['Ketone body', '0.4', '<0.6']] },
        { text: '', result: [['HbA1c', '5.1', '<5.7']] },
        { text: '', result: [['XX', '數值II', '正常值JJ']] },
        { text: '', result: [['XX', '數值KK', '正常值LL']] },
        { text: '', result: [['XX', '數值MM', '正常值NN']] }
    ],
    // 欄位 3: 影像檢查 (圖片和文字描述)
    [
        { text: 'CXR_入院', result: '', image: 'images/CXR1.jpg' },
        { text: 'CXR_Now', result: '', image: 'images/CXR0.jpg' },
        { text: 'EKG', result: '', image: 'images/EKG.jpg' },
        { text: 'Chest CT', result: '', image: 'images/CHEST_CT.gif' },
        { text: '', result: '', image: '' },
        { text: '', result: '', image: 'images/BRAIN_CT.gif' },
        ...
        { text: 'CXR_ETT', result: '', image: 'images/CXR_ETT.jpg' }
    ]
];
